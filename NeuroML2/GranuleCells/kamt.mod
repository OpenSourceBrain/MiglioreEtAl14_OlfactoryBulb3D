...
PARAMETER {
    ...
    m_steadyState_midpoint = 17.5 (mV)
    m_steadyState_scale = 14 (mV)
    m_forwardRate_rate = 1 (kHz)
    m_forwardRate_midpoint = -45 (mV)
    m_forwardRate_scale = 10 (mV)
    m_reverseRate_rate = 1 (kHz)
    m_reverseRate_midpoint = -45 (mV)
    m_reverseRate_scale = 13.333334 (mV)
    ...
    h_steadyState_midpoint = -41.7 (mV)
    h_steadyState_scale = -6 (mV)
    h_forwardRate_rate = 1 (kHz)
    h_forwardRate_midpoint = -70 (mV)
    h_forwardRate_scale = 5 (mV)
    h_reverseRate_rate = 1 (kHz)
    h_reverseRate_midpoint = -70 (mV)
    h_reverseRate_scale = 5.050505 (mV)
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: gatesHHrates[*]/fcond, on: Component(id=kamt type=ionChannelHH), from gatesHHrates; null
    ? Path not present in component, using factor: 1
    
    fopenHHrates = 1 
    
    ? DerivedVariable is based on path: gatesHHtauInf[*]/fcond, on: Component(id=kamt type=ionChannelHH), from gatesHHtauInf; null
    ? Path not present in component, using factor: 1
    
    fopenHHtauInf = 1 
    
    ? DerivedVariable is based on path: gatesHHratesTau[*]/fcond, on: Component(id=kamt type=ionChannelHH), from gatesHHratesTau; null
    ? Path not present in component, using factor: 1
    
    fopenHHratesTau = 1 
    
    ? DerivedVariable is based on path: gatesHHratesInf[*]/fcond, on: Component(id=kamt type=ionChannelHH), from gatesHHratesInf; null
    ? Path not present in component, using factor: 1
    
    fopenHHratesInf = 1 
    
    ? DerivedVariable is based on path: gatesHHratesTauInf[*]/fcond, on: Component(id=kamt type=ionChannelHH), from gatesHHratesTauInf; Component(id=m type=gateHHratesTauInf)
    fopenHHratesTauInf = m_fcond * h_fcond ? multiply applied to all instances of fcond in: <gatesHHratesTauInf> ([Component(id=m type=gateHHratesTauInf), Component(id=h type=gateHHratesTauInf)]) c2 ([Component(id=null type=annotation), Component(id=null type=notes), Component(id=m type=gateHHratesTauInf), Component(id=h type=gateHHratesTauInf)]) ? path based
...
PROCEDURE rates() {
    ...
    m_rateScale = m_q10Settings_q10 ? multiply applied to all instances of q10 in: <q10Settings> ([Component(id=null type=q10ExpTemp)]) c2 ([Component(id=null type=HHSigmoidVariable), Component(id=null type=HHExpRate), Component(id=null type=HHExpRate), Component(id=null type=kamt_m_tau_tau), Component(id=null type=q10ExpTemp)]) ? path based
    ...
    h_rateScale = h_q10Settings_q10 ? multiply applied to all instances of q10 in: <q10Settings> ([Component(id=null type=q10ExpTemp)]) c2 ([Component(id=null type=HHSigmoidVariable), Component(id=null type=HHExpRate), Component(id=null type=HHExpRate), Component(id=null type=kamt_h_tau_tau), Component(id=null type=q10ExpTemp)]) ? path based

...
class NEURON(NEURONCellTest):
    ...
    def __init__(self):
        ...
        self.label = "mitral_passive"
        self.resultsFile = "results/cells/mitral_passive/NEURON.json"
    ...
    def prepare(self, h):
        ...
        cell = model.mitrals[0]  # The first MC
...
class NeuroML(NeuroMLCellTest):
    def __init__(self):
        ...
        self.label = "mitral_passive"
        self.resultsFile = "results/cells/mitral_passive/NeuroML.json"
        self.id = "Mitral_0_0"
        self.currentRange = (-1, 3)
